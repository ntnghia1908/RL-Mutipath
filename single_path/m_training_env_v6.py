...
class Env():
    ...
    def step(self, vid, quality):
        last_down_segment = self.down_segment.copy()
        down_id = self.play_id + vid  # self.play_id is playing or just finish playing
        down_quality = quality
        ...
        return self.state, reward, self.end_of_video, chunk_state, sum_reward
