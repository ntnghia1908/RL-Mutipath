...
def main():
    ...
    epoch = []
    avg_rewards = []
    file_name = 'lr35_decay95_batch200_v11'
    ...
    if TEST == True:
        ...
        TrainNet.load_model(np.array([state], dtype='float32'), 'model/DQNmodel_new.h5')
        TargetNet.load_model(np.array([state], dtype='float32'), 'model/DQNmodel_new.h5')
