...
class Env():
    ...
    def step(self, action):
        ...
        if down_id > CHUNK_TIL_VIDEO_END_CAP - 1:
            return self.state, -100, self.end_of_video,"near_end", self.play_id, self.last_sum_reward
...
#????
        ...
        return self.state, reward , self.end_of_video, line, self.play_id, sum_reward
