from m_training_env_v13 import Env
...
def main():
    ...
    epoch = []
    avg_rewards = []
    file_name = 'DQNmodel_lr4_decay99_batch200_v13_test'
    ...
    if TEST == True:
        ...
        TrainNet.load_model(np.array([state], dtype='float32'), 'model/DQNmodel_lr4_decay99_batch200_v13.h5')
        TargetNet.load_model(np.array([state], dtype='float32'), 'model/DQNmodel_lr4_decay99_batch200_v13.h5')
